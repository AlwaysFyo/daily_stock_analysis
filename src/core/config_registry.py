...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "ENABLE_PORTFOLIO_FEATURE": {
        "title": "Enable Portfolio Feature",
        "description": "Enable portfolio management feature in web UI. Disable to hide portfolio page and menu.",
        "category": "webui",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
